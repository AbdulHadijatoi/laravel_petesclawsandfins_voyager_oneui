...
<script> 
    function onLoad() {
        setGreyBackground(2, 8, 'pattern2.png');
        setGreyBackground(1, 9, 'pattern3.png');
        setGreyBackground(0, 20, 'pattern4.png');
    ...
    function setGreyBackground(containerIndex, frameIndex, patternImage) {
        frameIndex -= 1;
        greyContainer[containerIndex].innerHTML = bg_frame[frameIndex].replace("_GREY_SHADE_IMAGE_HERE_", "../patterns/" + patternImage);
    }
</script>
@endsection
