...
@section('title', 'Welcome Investor')
...
@section('main-menu-items')
    ...
    <li><a href="#">Future Ideas</a></li>
    <li><a href="#">Financial Updates</a></li>
...
<section id="section2" class="full-width h1000 align-in-center md_h1200 sm_h1100">
...
<section id="section1" class="full-width h1100 align-in-center md_h1250">
